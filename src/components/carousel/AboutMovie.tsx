...
export const AboutMovie = ({ movie }: AboutMovieProps) => {
  ...
  return (
    <div>
      <div className="static foreground lg:absolute lg:top-1/2 lg:left-[140px] lg:-translate-y-1/2 lg:text-white z-10">
        <div className="p-5 space-y-6 lg:p-0">
          <div className="flex justify-between lg:flex-col lg:space-y-1">
            <div>
              <h4 className="text-sm">Now Playin</h4>
